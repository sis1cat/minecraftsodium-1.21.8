...
public interface FluidRenderHandler {
	...
	default void renderFluid(BlockPos pos, BlockAndTintGetter world, VertexConsumer vertexConsumer, BlockState blockState, FluidState fluidState, double x, double y, double z) {
