...
public class FlyNodeEvaluator extends WalkNodeEvaluator {
	...
	private Iterable<BlockPos> iteratePathfindingStartNodeCandidatePositions(Mob mob) {
		...
		if (!bl) {
			return List.of(
				BlockPos.containing(aABB.minX, mob.getBlockY(), aABB.minZ),
				BlockPos.containing(aABB.minX, mob.getBlockY(), aABB.maxZ),
				BlockPos.containing(aABB.maxX, mob.getBlockY(), aABB.minZ),
				BlockPos.containing(aABB.maxX, mob.getBlockY(), aABB.maxZ)
			);
		} else {
