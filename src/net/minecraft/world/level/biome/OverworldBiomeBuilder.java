...
public final class OverworldBiomeBuilder {
	...
	public String getDebugStringForContinentalness(double d) {
		...
		if (e < this.mushroomFieldsContinentalness.max()) {
			return "Mushroom fields";
		} else if (e < this.deepOceanContinentalness.max()) {
			return "Deep ocean";
		} else if (e < this.oceanContinentalness.max()) {
			return "Ocean";
		} else if (e < this.coastContinentalness.max()) {
			return "Coast";
		} else if (e < this.nearInlandContinentalness.max()) {
			return "Near inland";
		} else {
			return e < this.midInlandContinentalness.max() ? "Mid inland" : "Far inland";
		}
	}
