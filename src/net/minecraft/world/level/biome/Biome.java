...
public final class Biome {
	...
	private void setupColors() {
		...
		Optional<Integer> grassColor = this.cachedSpecialEffects.getGrassColorOverride();
		...
		Optional<Integer> foliageColor = this.cachedSpecialEffects.getFoliageColorOverride();
