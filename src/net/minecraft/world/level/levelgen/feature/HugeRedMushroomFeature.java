				...
				for (int n = -k; n <= k; n++) {
					...
					if (j >= i || bl5 != bl6) {
						...
						if (blockState.hasProperty(HugeMushroomBlock.WEST)
							...
							blockState = blockState.setValue(HugeMushroomBlock.UP, j >= i - 1)
								.setValue(HugeMushroomBlock.WEST, m < -l)
								.setValue(HugeMushroomBlock.EAST, m > l)
								.setValue(HugeMushroomBlock.NORTH, n < -l)
								.setValue(HugeMushroomBlock.SOUTH, n > l);
						}
