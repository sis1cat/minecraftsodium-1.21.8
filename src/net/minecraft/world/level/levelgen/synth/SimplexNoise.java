...
public class SimplexNoise {
	...
	public double getValue(double d, double e, double f) {
		...
		double m = (i + j + k) * 0.16666666666666666;
		double n = i - m;
		double o = j - m;
		double p = k - m;
		double q = d - n;
		...
		double z = q - t + 0.16666666666666666;
		double aa = r - u + 0.16666666666666666;
		double ab = s - v + 0.16666666666666666;
		double ac = q - w + 0.3333333333333333;
		double ad = r - x + 0.3333333333333333;
		double ae = s - y + 0.3333333333333333;
		double af = q - 1.0 + 0.5;
		double ag = r - 1.0 + 0.5;
		double ah = s - 1.0 + 0.5;
		int ai = i & 0xFF;
