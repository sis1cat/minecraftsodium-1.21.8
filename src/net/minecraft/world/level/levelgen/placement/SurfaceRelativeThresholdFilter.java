...
public class SurfaceRelativeThresholdFilter extends PlacementFilter {
	public static final MapCodec<SurfaceRelativeThresholdFilter> CODEC = RecordCodecBuilder.mapCodec(
		instance -> instance.group(
				...
				Codec.INT.optionalFieldOf("min_inclusive", Integer.MIN_VALUE).forGetter(surfaceRelativeThresholdFilter -> surfaceRelativeThresholdFilter.minInclusive),
				Codec.INT.optionalFieldOf("max_inclusive", Integer.MAX_VALUE).forGetter(surfaceRelativeThresholdFilter -> surfaceRelativeThresholdFilter.maxInclusive)
			)
	...
	protected boolean shouldPlace(PlacementContext placementContext, RandomSource randomSource, BlockPos blockPos) {
		...
		long m = l + this.minInclusive;
		long n = l + this.maxInclusive;
		return m <= blockPos.getY() && blockPos.getY() <= n;
	}
