...
public class Items {
	...
	public static final Item ARMADILLO_SPAWN_EGG = registerItem("armadillo_spawn_egg", properties -> new SpawnEggItem(EntityType.ARMADILLO, properties));
	public static final Item ALLAY_SPAWN_EGG = registerItem("allay_spawn_egg", properties -> new SpawnEggItem(EntityType.ALLAY, properties));
	public static final Item AXOLOTL_SPAWN_EGG = registerItem("axolotl_spawn_egg", properties -> new SpawnEggItem(EntityType.AXOLOTL, properties));
	public static final Item BAT_SPAWN_EGG = registerItem("bat_spawn_egg", properties -> new SpawnEggItem(EntityType.BAT, properties));
	public static final Item BEE_SPAWN_EGG = registerItem("bee_spawn_egg", properties -> new SpawnEggItem(EntityType.BEE, properties));
	public static final Item BLAZE_SPAWN_EGG = registerItem("blaze_spawn_egg", properties -> new SpawnEggItem(EntityType.BLAZE, properties));
	public static final Item BOGGED_SPAWN_EGG = registerItem("bogged_spawn_egg", properties -> new SpawnEggItem(EntityType.BOGGED, properties));
	public static final Item BREEZE_SPAWN_EGG = registerItem("breeze_spawn_egg", properties -> new SpawnEggItem(EntityType.BREEZE, properties));
	public static final Item CAT_SPAWN_EGG = registerItem("cat_spawn_egg", properties -> new SpawnEggItem(EntityType.CAT, properties));
	public static final Item CAMEL_SPAWN_EGG = registerItem("camel_spawn_egg", properties -> new SpawnEggItem(EntityType.CAMEL, properties));
	public static final Item CAVE_SPIDER_SPAWN_EGG = registerItem("cave_spider_spawn_egg", properties -> new SpawnEggItem(EntityType.CAVE_SPIDER, properties));
	public static final Item CHICKEN_SPAWN_EGG = registerItem("chicken_spawn_egg", properties -> new SpawnEggItem(EntityType.CHICKEN, properties));
	public static final Item COD_SPAWN_EGG = registerItem("cod_spawn_egg", properties -> new SpawnEggItem(EntityType.COD, properties));
	public static final Item COW_SPAWN_EGG = registerItem("cow_spawn_egg", properties -> new SpawnEggItem(EntityType.COW, properties));
	public static final Item CREEPER_SPAWN_EGG = registerItem("creeper_spawn_egg", properties -> new SpawnEggItem(EntityType.CREEPER, properties));
	public static final Item DOLPHIN_SPAWN_EGG = registerItem("dolphin_spawn_egg", properties -> new SpawnEggItem(EntityType.DOLPHIN, properties));
	public static final Item DONKEY_SPAWN_EGG = registerItem("donkey_spawn_egg", properties -> new SpawnEggItem(EntityType.DONKEY, properties));
	public static final Item DROWNED_SPAWN_EGG = registerItem("drowned_spawn_egg", properties -> new SpawnEggItem(EntityType.DROWNED, properties));
	public static final Item ELDER_GUARDIAN_SPAWN_EGG = registerItem(
		"elder_guardian_spawn_egg", properties -> new SpawnEggItem(EntityType.ELDER_GUARDIAN, properties)
	);
	public static final Item ENDER_DRAGON_SPAWN_EGG = registerItem("ender_dragon_spawn_egg", properties -> new SpawnEggItem(EntityType.ENDER_DRAGON, properties));
	public static final Item ENDERMAN_SPAWN_EGG = registerItem("enderman_spawn_egg", properties -> new SpawnEggItem(EntityType.ENDERMAN, properties));
	public static final Item ENDERMITE_SPAWN_EGG = registerItem("endermite_spawn_egg", properties -> new SpawnEggItem(EntityType.ENDERMITE, properties));
	public static final Item EVOKER_SPAWN_EGG = registerItem("evoker_spawn_egg", properties -> new SpawnEggItem(EntityType.EVOKER, properties));
	public static final Item FOX_SPAWN_EGG = registerItem("fox_spawn_egg", properties -> new SpawnEggItem(EntityType.FOX, properties));
	public static final Item FROG_SPAWN_EGG = registerItem("frog_spawn_egg", properties -> new SpawnEggItem(EntityType.FROG, properties));
	public static final Item GHAST_SPAWN_EGG = registerItem("ghast_spawn_egg", properties -> new SpawnEggItem(EntityType.GHAST, properties));
	public static final Item HAPPY_GHAST_SPAWN_EGG = registerItem("happy_ghast_spawn_egg", properties -> new SpawnEggItem(EntityType.HAPPY_GHAST, properties));
	public static final Item GLOW_SQUID_SPAWN_EGG = registerItem("glow_squid_spawn_egg", properties -> new SpawnEggItem(EntityType.GLOW_SQUID, properties));
	public static final Item GOAT_SPAWN_EGG = registerItem("goat_spawn_egg", properties -> new SpawnEggItem(EntityType.GOAT, properties));
	public static final Item GUARDIAN_SPAWN_EGG = registerItem("guardian_spawn_egg", properties -> new SpawnEggItem(EntityType.GUARDIAN, properties));
	public static final Item HOGLIN_SPAWN_EGG = registerItem("hoglin_spawn_egg", properties -> new SpawnEggItem(EntityType.HOGLIN, properties));
	public static final Item HORSE_SPAWN_EGG = registerItem("horse_spawn_egg", properties -> new SpawnEggItem(EntityType.HORSE, properties));
	public static final Item HUSK_SPAWN_EGG = registerItem("husk_spawn_egg", properties -> new SpawnEggItem(EntityType.HUSK, properties));
	public static final Item IRON_GOLEM_SPAWN_EGG = registerItem("iron_golem_spawn_egg", properties -> new SpawnEggItem(EntityType.IRON_GOLEM, properties));
	public static final Item LLAMA_SPAWN_EGG = registerItem("llama_spawn_egg", properties -> new SpawnEggItem(EntityType.LLAMA, properties));
	public static final Item MAGMA_CUBE_SPAWN_EGG = registerItem("magma_cube_spawn_egg", properties -> new SpawnEggItem(EntityType.MAGMA_CUBE, properties));
	public static final Item MOOSHROOM_SPAWN_EGG = registerItem("mooshroom_spawn_egg", properties -> new SpawnEggItem(EntityType.MOOSHROOM, properties));
	public static final Item MULE_SPAWN_EGG = registerItem("mule_spawn_egg", properties -> new SpawnEggItem(EntityType.MULE, properties));
	public static final Item OCELOT_SPAWN_EGG = registerItem("ocelot_spawn_egg", properties -> new SpawnEggItem(EntityType.OCELOT, properties));
	public static final Item PANDA_SPAWN_EGG = registerItem("panda_spawn_egg", properties -> new SpawnEggItem(EntityType.PANDA, properties));
	public static final Item PARROT_SPAWN_EGG = registerItem("parrot_spawn_egg", properties -> new SpawnEggItem(EntityType.PARROT, properties));
	public static final Item PHANTOM_SPAWN_EGG = registerItem("phantom_spawn_egg", properties -> new SpawnEggItem(EntityType.PHANTOM, properties));
	public static final Item PIG_SPAWN_EGG = registerItem("pig_spawn_egg", properties -> new SpawnEggItem(EntityType.PIG, properties));
	public static final Item PIGLIN_SPAWN_EGG = registerItem("piglin_spawn_egg", properties -> new SpawnEggItem(EntityType.PIGLIN, properties));
	public static final Item PIGLIN_BRUTE_SPAWN_EGG = registerItem("piglin_brute_spawn_egg", properties -> new SpawnEggItem(EntityType.PIGLIN_BRUTE, properties));
	public static final Item PILLAGER_SPAWN_EGG = registerItem("pillager_spawn_egg", properties -> new SpawnEggItem(EntityType.PILLAGER, properties));
	public static final Item POLAR_BEAR_SPAWN_EGG = registerItem("polar_bear_spawn_egg", properties -> new SpawnEggItem(EntityType.POLAR_BEAR, properties));
	public static final Item PUFFERFISH_SPAWN_EGG = registerItem("pufferfish_spawn_egg", properties -> new SpawnEggItem(EntityType.PUFFERFISH, properties));
	public static final Item RABBIT_SPAWN_EGG = registerItem("rabbit_spawn_egg", properties -> new SpawnEggItem(EntityType.RABBIT, properties));
	public static final Item RAVAGER_SPAWN_EGG = registerItem("ravager_spawn_egg", properties -> new SpawnEggItem(EntityType.RAVAGER, properties));
	public static final Item SALMON_SPAWN_EGG = registerItem("salmon_spawn_egg", properties -> new SpawnEggItem(EntityType.SALMON, properties));
	public static final Item SHEEP_SPAWN_EGG = registerItem("sheep_spawn_egg", properties -> new SpawnEggItem(EntityType.SHEEP, properties));
	public static final Item SHULKER_SPAWN_EGG = registerItem("shulker_spawn_egg", properties -> new SpawnEggItem(EntityType.SHULKER, properties));
	public static final Item SILVERFISH_SPAWN_EGG = registerItem("silverfish_spawn_egg", properties -> new SpawnEggItem(EntityType.SILVERFISH, properties));
	public static final Item SKELETON_SPAWN_EGG = registerItem("skeleton_spawn_egg", properties -> new SpawnEggItem(EntityType.SKELETON, properties));
	public static final Item SKELETON_HORSE_SPAWN_EGG = registerItem(
		"skeleton_horse_spawn_egg", properties -> new SpawnEggItem(EntityType.SKELETON_HORSE, properties)
	);
	public static final Item SLIME_SPAWN_EGG = registerItem("slime_spawn_egg", properties -> new SpawnEggItem(EntityType.SLIME, properties));
	public static final Item SNIFFER_SPAWN_EGG = registerItem("sniffer_spawn_egg", properties -> new SpawnEggItem(EntityType.SNIFFER, properties));
	public static final Item SNOW_GOLEM_SPAWN_EGG = registerItem("snow_golem_spawn_egg", properties -> new SpawnEggItem(EntityType.SNOW_GOLEM, properties));
	public static final Item SPIDER_SPAWN_EGG = registerItem("spider_spawn_egg", properties -> new SpawnEggItem(EntityType.SPIDER, properties));
	public static final Item SQUID_SPAWN_EGG = registerItem("squid_spawn_egg", properties -> new SpawnEggItem(EntityType.SQUID, properties));
	public static final Item STRAY_SPAWN_EGG = registerItem("stray_spawn_egg", properties -> new SpawnEggItem(EntityType.STRAY, properties));
	public static final Item STRIDER_SPAWN_EGG = registerItem("strider_spawn_egg", properties -> new SpawnEggItem(EntityType.STRIDER, properties));
	public static final Item TADPOLE_SPAWN_EGG = registerItem("tadpole_spawn_egg", properties -> new SpawnEggItem(EntityType.TADPOLE, properties));
	public static final Item TRADER_LLAMA_SPAWN_EGG = registerItem("trader_llama_spawn_egg", properties -> new SpawnEggItem(EntityType.TRADER_LLAMA, properties));
	public static final Item TROPICAL_FISH_SPAWN_EGG = registerItem(
		"tropical_fish_spawn_egg", properties -> new SpawnEggItem(EntityType.TROPICAL_FISH, properties)
	);
	public static final Item TURTLE_SPAWN_EGG = registerItem("turtle_spawn_egg", properties -> new SpawnEggItem(EntityType.TURTLE, properties));
	public static final Item VEX_SPAWN_EGG = registerItem("vex_spawn_egg", properties -> new SpawnEggItem(EntityType.VEX, properties));
	public static final Item VILLAGER_SPAWN_EGG = registerItem("villager_spawn_egg", properties -> new SpawnEggItem(EntityType.VILLAGER, properties));
	public static final Item VINDICATOR_SPAWN_EGG = registerItem("vindicator_spawn_egg", properties -> new SpawnEggItem(EntityType.VINDICATOR, properties));
	public static final Item WANDERING_TRADER_SPAWN_EGG = registerItem(
		"wandering_trader_spawn_egg", properties -> new SpawnEggItem(EntityType.WANDERING_TRADER, properties)
	);
	public static final Item WARDEN_SPAWN_EGG = registerItem("warden_spawn_egg", properties -> new SpawnEggItem(EntityType.WARDEN, properties));
	public static final Item WITCH_SPAWN_EGG = registerItem("witch_spawn_egg", properties -> new SpawnEggItem(EntityType.WITCH, properties));
	public static final Item WITHER_SPAWN_EGG = registerItem("wither_spawn_egg", properties -> new SpawnEggItem(EntityType.WITHER, properties));
	public static final Item WITHER_SKELETON_SPAWN_EGG = registerItem(
		"wither_skeleton_spawn_egg", properties -> new SpawnEggItem(EntityType.WITHER_SKELETON, properties)
	);
	public static final Item WOLF_SPAWN_EGG = registerItem("wolf_spawn_egg", properties -> new SpawnEggItem(EntityType.WOLF, properties));
	public static final Item ZOGLIN_SPAWN_EGG = registerItem("zoglin_spawn_egg", properties -> new SpawnEggItem(EntityType.ZOGLIN, properties));
	public static final Item CREAKING_SPAWN_EGG = registerItem("creaking_spawn_egg", properties -> new SpawnEggItem(EntityType.CREAKING, properties));
	public static final Item ZOMBIE_SPAWN_EGG = registerItem("zombie_spawn_egg", properties -> new SpawnEggItem(EntityType.ZOMBIE, properties));
	public static final Item ZOMBIE_HORSE_SPAWN_EGG = registerItem("zombie_horse_spawn_egg", properties -> new SpawnEggItem(EntityType.ZOMBIE_HORSE, properties));
	public static final Item ZOMBIE_VILLAGER_SPAWN_EGG = registerItem(
		"zombie_villager_spawn_egg", properties -> new SpawnEggItem(EntityType.ZOMBIE_VILLAGER, properties)
	);
	public static final Item ZOMBIFIED_PIGLIN_SPAWN_EGG = registerItem(
		"zombified_piglin_spawn_egg", properties -> new SpawnEggItem(EntityType.ZOMBIFIED_PIGLIN, properties)
	);
