...
public class HangingSignItem extends SignItem {
	...
	protected boolean canPlace(LevelReader levelReader, BlockState blockState, BlockPos blockPos) {
		return blockState.getBlock() instanceof WallHangingSignBlock wallHangingSignBlock && !wallHangingSignBlock.canPlace(blockState, levelReader, blockPos)
			? false
			: super.canPlace(levelReader, blockState, blockPos);
	}
}
