...
public class VillagerGoalPackages {
	...
	public static ImmutableList<Pair<Integer, ? extends BehaviorControl<? super Villager>>> getCorePackage(Holder<VillagerProfession> holder, float f) {
		return ImmutableList.of(
			...
			Pair.of(
				6,
				AcquirePoi.create(
					holder.value().acquirableJobSite(),
			...
			Pair.of(
				10, AcquirePoi.create(holderx -> holderx.is(PoiTypes.HOME), MemoryModuleType.HOME, false, Optional.of((byte)14), VillagerGoalPackages::validateBedPoi)
			),
			...
			Pair.of(
				...
				new RunOne<>(
					ImmutableList.of(
						...
						Pair.of(new HarvestFarmland(), holder.is(VillagerProfession.FARMER) ? 2 : 5),
						Pair.of(new UseBonemeal(), holder.is(VillagerProfession.FARMER) ? 4 : 7)
					)
				)
			),
	...
	public static ImmutableList<Pair<Integer, ? extends BehaviorControl<? super Villager>>> getRestPackage(Holder<VillagerProfession> holder, float f) {
		return ImmutableList.of(
			Pair.of(2, SetWalkTargetFromBlockMemory.create(MemoryModuleType.HOME, f, 1, 150, 1200)),
			Pair.of(3, ValidateNearbyPoi.create(holderx -> holderx.is(PoiTypes.HOME), MemoryModuleType.HOME)),
	...
	public static ImmutableList<Pair<Integer, ? extends BehaviorControl<? super Villager>>> getMeetPackage(Holder<VillagerProfession> holder, float f) {
		return ImmutableList.of(
			Pair.of(
				2,
			...
			Pair.of(3, new GiveGiftToHero(100)),
			Pair.of(3, ValidateNearbyPoi.create(holderx -> holderx.is(PoiTypes.MEETING), MemoryModuleType.MEETING_POINT)),
			Pair.of(
				3,
				new GateBehavior<>(
					ImmutableMap.of(),
