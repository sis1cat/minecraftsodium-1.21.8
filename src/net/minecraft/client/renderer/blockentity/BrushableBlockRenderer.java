...
public class BrushableBlockRenderer implements BlockEntityRenderer<BrushableBlockEntity> {
	...
	public void render(BrushableBlockEntity brushableBlockEntity, float f, PoseStack poseStack, MultiBufferSource multiBufferSource, int i, int j, Vec3 vec3) {
				...
				if (direction != null) {
					...
					if (!itemStack.isEmpty()) {
						...
						int l = LevelRenderer.getLightColor(
							...
							brushableBlockEntity.getBlockPos().relative(direction)
						);
						this.itemRenderer
