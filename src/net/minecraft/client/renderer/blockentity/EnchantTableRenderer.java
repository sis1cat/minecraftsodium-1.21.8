...
public class EnchantTableRenderer implements BlockEntityRenderer<EnchantingTableBlockEntity> {
	...
	public void render(
		EnchantingTableBlockEntity enchantingTableBlockEntity, float f, PoseStack poseStack, MultiBufferSource multiBufferSource, int i, int j, Vec3 vec3
	) {
		poseStack.pushPose();
		poseStack.translate(0.5F, 0.75F, 0.5F);
		float g = enchantingTableBlockEntity.time + f;
