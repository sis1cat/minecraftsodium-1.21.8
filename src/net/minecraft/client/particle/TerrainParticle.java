...
public class TerrainParticle extends TextureSheetParticle {
	...
	private TextureAtlasSprite getModelParticleSpriteProxy(BlockModelShaper models, BlockState state, Level world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, BlockState state1, BlockPos blockPos) {
	...
	public TerrainParticle(ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, BlockState blockState, BlockPos blockPos) {
		...
		this.pos = blockPos;
		this.setSprite(getModelParticleSpriteProxy(Minecraft.getInstance().getBlockRenderer().getBlockModelShaper(), blockState, clientLevel, d, e, f, g, h, i, blockState, blockPos));
