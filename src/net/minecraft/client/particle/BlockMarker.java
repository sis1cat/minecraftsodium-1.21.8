...
public class BlockMarker extends TextureSheetParticle {
	...
	private TextureAtlasSprite getModelParticleSpriteProxy(BlockModelShaper models, BlockState state, Level world, double x, double y, double z) {
	...
	BlockMarker(ClientLevel clientLevel, double d, double e, double f, BlockState blockState) {
		...
		this.setSprite(getModelParticleSpriteProxy(Minecraft.getInstance().getBlockRenderer().getBlockModelShaper(), blockState, clientLevel, d, e, f));
