...
public class OptionsMenuBlurrinessFix extends DataFix {
	...
	public TypeRewriteRule makeRule() {
		return this.fixTypeEverywhereTyped(
			...
			typed -> typed.update(DSL.remainderFinder(), dynamic -> dynamic.update("menuBackgroundBlurriness", dynamicx -> {
				int i = this.convertToIntRange(dynamicx.asString("0.5"));
				return dynamicx.createString(String.valueOf(i));
			}))
		);
	}
