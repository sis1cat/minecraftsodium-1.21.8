...
public class V3818_3 extends NamespacedSchema {
	...
	public static SequencedMap<String, Supplier<TypeTemplate>> components(Schema schema) {
		...
		sequencedMap.put("minecraft:custom_name", (Supplier)() -> References.TEXT_COMPONENT.in(schema));
		sequencedMap.put("minecraft:item_name", (Supplier)() -> References.TEXT_COMPONENT.in(schema));
		sequencedMap.put("minecraft:lore", (Supplier)() -> DSL.list(References.TEXT_COMPONENT.in(schema)));
		sequencedMap.put(
