...
public class PlaceCommand {
	...
	public static int placeTemplate(
		CommandSourceStack commandSourceStack, ResourceLocation resourceLocation, BlockPos blockPos, Rotation rotation, Mirror mirror, float f, int i, boolean bl
	) throws CommandSyntaxException {
		ServerLevel serverLevel = commandSourceStack.getLevel();
		...
		if (optional.isEmpty()) {
			...
			boolean bl2 = structureTemplate.placeInWorld(
				serverLevel, blockPos, blockPos, structurePlaceSettings, StructureBlockEntity.createRandom(i), 2 | (bl ? 816 : 0)
			);
			if (!bl2) {
