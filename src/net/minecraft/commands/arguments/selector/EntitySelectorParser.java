...
public class EntitySelectorParser {
	...
	private Predicate<Entity> createRotationPredicate(WrappedMinMaxBounds wrappedMinMaxBounds, ToDoubleFunction<Entity> toDoubleFunction) {
		double d = Mth.wrapDegrees(wrappedMinMaxBounds.min() == null ? 0.0F : wrappedMinMaxBounds.min());
		double e = Mth.wrapDegrees(wrappedMinMaxBounds.max() == null ? 359.0F : wrappedMinMaxBounds.max());
		return entity -> {
