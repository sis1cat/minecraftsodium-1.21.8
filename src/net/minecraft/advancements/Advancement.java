...
public record Advancement(
	...
	public static class Builder {
		...
		public Advancement.Builder display(
			...
			return this.display(
				new DisplayInfo(itemStack, component, component2, Optional.ofNullable(resourceLocation).map(ClientAsset::new), advancementType, bl, bl2, bl3)
			);
		}
		...
		public Advancement.Builder display(
			...
			return this.display(
				new DisplayInfo(
					new ItemStack(itemLike.asItem()), component, component2, Optional.ofNullable(resourceLocation).map(ClientAsset::new), advancementType, bl, bl2, bl3
				)
			);
		}
