...
public class DisplayInfo {
	...
	private static DisplayInfo fromNetwork(RegistryFriendlyByteBuf registryFriendlyByteBuf) {
		...
		Optional<ClientAsset> optional = (i & 1) != 0 ? Optional.of(new ClientAsset(registryFriendlyByteBuf.readResourceLocation())) : Optional.empty();
		boolean bl = (i & 2) != 0;
		boolean bl2 = (i & 4) != 0;
