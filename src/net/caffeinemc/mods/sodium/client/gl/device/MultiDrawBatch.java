...
public final class MultiDrawBatch {
   ...
   public MultiDrawBatch(int capacity) {
      ...
      this.pElementCount = MemoryUtil.nmemAlignedAlloc(32L, capacity * 4L);
      this.pBaseVertex = MemoryUtil.nmemAlignedAlloc(32L, capacity * 4L);
   ...
   public int getIndexBufferSize() {
      ...
      for (int index = 0; index < this.size; index++) {
         elements = Math.max(elements, MemoryUtil.memGetInt(this.pElementCount + index * 4L));
      }
