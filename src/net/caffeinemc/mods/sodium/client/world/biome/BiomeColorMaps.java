...
public class BiomeColorMaps {
   ...
   public static int getGrassColor(int index) {
      return index != -1 && index < GrassColor.pixels.length ? GrassColor.pixels[index] : GrassColor.getDefaultColor();
   }

   public static int getFoliageColor(int index) {
      return index != -1 && index < FoliageColor.pixels.length ? FoliageColor.pixels[index] : -12012264;
   }
